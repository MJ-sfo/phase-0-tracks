...
# Release 2: Analyze state_data -one state hash , includes a sub-hash with keys and numbers
# outer hash links keys with hash-rocket because key is text.  inner-hash has symbols with colins 
